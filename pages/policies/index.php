...
<p class="policies">A sua privacidade é importante para nós. É política da <em>Vênus Shop</em> respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <em>Vênus Shop</em>, e outros sites que possuímos e operamos.</p>
    ...
    <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que a <em>Vênus Shop</em> oferece no site e com caráter enunciativo, mas não limitativo:</p>
    <ol type="A">
        ...
        <li>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) da <em>Vênus Shop</em>, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
    </ol>
